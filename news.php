    ...
    <div class="container">
      <div class="content">
        ...
        Mizzou SURF is submitting for the virtual 2021 Robosub competition. Though there is no in-person competition in San Diego, CA this year, we are excited to show off Jelly through our videos and technical reports. This will be SURF's second time competing in the competition.
          ...
          <hr class="fancy">
        <div class="newsArticles">
        <h4 class="articleTitle">4/29/21 - New Home!</h4>
        ...
        <hr class="fancy">
        <div class="newsArticles">
        <h4 class="articleTitle">8/26/20 - SURF 2020-2021 Kicks Off</h4>
      ...
      <hr class="fancy">
        <div class="newsArticles">
        <h4 class="articleTitle">4/8/20 - Elections and Virtual Meetings</h4>
      ...
      <hr class="fancy">
        <div class="newsArticles">
        <h4 class="articleTitle">2/3/20 - Jelly's First Swim </h4>
      ...
      <hr class="fancy">
        <div class="newsArticles">
        <h4 class="articleTitle">11/26/19 - St. Louis High School Tour </h4>
      ...
      <hr class="fancy">
        <div class="newsArticles">
        <h4 class="articleTitle">8/5/19 - First Annual Robosub Competition </h4>
      ...
      <hr class="fancy">
        <div class="newsArticles">
          <h4 class="articleTitle">9/3/2018 - New Smester Excitement</h4>
        ...
        <hr class="fancy">
        <div class="newsArticles">
          <h4 class="articleTitle">2/26/2018 - Making Progress on the AUV</h4>
        ...
        <hr class="fancy">
        <div class="newsArticles">
          <h4 class="articleTitle">12/07/2017 - Lastest Donation</h4>
